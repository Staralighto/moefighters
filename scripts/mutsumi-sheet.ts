...
const dir = join(dirname(fileURLToPath(import.meta.url)), '..', 'public', 'sprites', 'mutsumi');
...
const targets = ['common.png', 'special.png', 'mortis.png', 'cucumber.png', 'note.png'].map(name => join(dir, name));
...
rasterSheet(join(dir, 'mortis.png'), mortis, SPECIAL_COLS * CELL, SPECIAL_ROWS * CELL);
rasterSheet(join(dir, 'cucumber.png'), cucumber, CELL, CELL);
